...
export default function FocusHero3D({ score }) {
  ...
  return (
    <div className="glass-panel w-full h-[280px] rounded-3xl relative overflow-hidden flex items-center justify-center group p-2">
      ...
      <div className="absolute bottom-0 right-4 z-20 flex items-center gap-4 bg-[#09090b] border border-white/10 px-5 py-3 rounded-2xl shadow-2xl transition-colors cursor-default">
