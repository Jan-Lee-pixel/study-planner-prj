...
export default function FocusHero3D({ score }) {
  ...
  return (
    <div className="glass-panel w-full h-[320px] rounded-3xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between group p-2">
      
      {/* 1. LEFT STATS (Floating HUD) */}
      <div className="relative z-10 p-8 flex flex-col justify-center h-full w-full md:w-1/3 pointer-events-none space-y-6">
      ...
      {/* 3. RIGHT "COVER-UP" CARD (The Streak) */}
